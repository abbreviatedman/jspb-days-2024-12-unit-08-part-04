...
// a search for 'Billy Joel' / 'Piano Man' fails to find lyrics (response 404)
    ...
    // if Artist of Title fields are cleared (for a new Search), clear the lyrics 
    
    // 'Please input an Artist and Title!';
    ...
    // .t
        ...
        // if ! // if response object has NO error property
            let lyrics;
            // 'Paroles de la chanson'
            // 'par'
            // '\n'

        // response object HAS error property, so no lyrics found
